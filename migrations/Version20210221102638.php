 ...
 */
final class Version20210221102638 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pictures (id INT AUTO_INCREMENT NOT NULL, comments_id INT DEFAULT NULL, property_id INT DEFAULT NULL, activities_id INT DEFAULT NULL, url VARCHAR(255) NOT NULL, max_size INT NOT NULL, status LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', file_path VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_8F7C2FC063379586 (comments_id), INDEX IDX_8F7C2FC0549213EC (property_id), INDEX IDX_8F7C2FC02A4DB562 (activities_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, type_property_id INT DEFAULT NULL, user_id INT DEFAULT NULL, equipment_id INT DEFAULT NULL, address_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, description VARCHAR(255) NOT NULL, surface INT NOT NULL, nbr_room INT NOT NULL, rate DOUBLE PRECISION NOT NULL, max_travelers INT NOT NULL, access_handicap TINYINT(1) NOT NULL, water VARCHAR(50) NOT NULL, electricity TINYINT(1) NOT NULL, tax DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_8BF21CDE1F8BC47D (type_property_id), INDEX IDX_8BF21CDEA76ED395 (user_id), INDEX IDX_8BF21CDE517FE9FE (equipment_id), UNIQUE INDEX UNIQ_8BF21CDEF5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE propriete (id INT AUTO_INCREMENT NOT NULL, type_value_id INT DEFAULT NULL, nom VARCHAR(100) NOT NULL, is_required TINYINT(1) NOT NULL, type VARCHAR(20) DEFAULT NULL, INDEX IDX_73A85B9334DF9C5E (type_value_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, roles JSON NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
